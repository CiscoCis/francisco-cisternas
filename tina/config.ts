  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            type: 'image',
            name: 'photo',
            label: 'Photo (optional — without one the card falls back to a text-only treatment)',
            uploadDir: () => 'beyond',
          },
          { type: 'string', name: 'photoAlt', label: 'Photo alt text' },
          {
            type: 'string',
            name: 'note',
            label: 'A sentence or two, in his own words',
            ui: { component: 'textarea' },
          },
          { type: 'boolean', name: 'draft', label: 'Draft (hidden from the live site)' },
        ],
      },
      {
        ...
        ui: { router: () => undefined },
        fields: [
          { type: 'string', name: 'title', label: 'Name / title', isTitle: true, required: true },
          {
            type: 'string',
            name: 'category',
            label: 'Category',
            options: ['Person', 'Website', 'Article', 'Blog post', 'Other resource'],
          },
          {
            type: 'string',
            name: 'description',
            label: 'Why he recommends it (1-2 sentences)',
            ui: { component: 'textarea' },
          },
      ...
      },
      {
        ...
        label: 'Forum — Conversations',
        path: 'content/forum-conversations',
        format: 'json',
        ui: { router: () => undefined },
        fields: [
          {
          ...
          { type: 'string', name: 'title', label: 'Title', isTitle: true, required: true },
          {
            ...
            label: 'Kind',
            required: true,
            options: ['Discussion', 'Question of the Week', 'Community Case'],
          },
          {
            type: 'string',
            name: 'category',
          ...
          { type: 'string', name: 'date', label: 'Date (YYYY-MM-DD)', required: true },
          {
            type: 'string',
            name: 'excerpt',
            label: 'Excerpt (1-2 sentences, shown on cards)',
            ui: { component: 'textarea' },
          },
          {
            type: 'object',
          ...
          },
          {
            ...
            label: 'Guest author name (leave blank for Francisco)',
          },
          {
            type: 'string',
            name: 'guestAuthorUrl',
            label: 'Guest author link (their site — shown as "guest contributor")',
          },
          { type: 'boolean', name: 'pinned', label: 'Pinned to the top of Conversations' },
          { type: 'boolean', name: 'featured', label: 'Featured on the Forum home' },
          { type: 'boolean', name: 'locked', label: 'Locked (hides the comment form)' },
          { type: 'boolean', name: 'draft', label: 'Draft (hidden from the live site)' },
        ],
      },
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'name', label: 'Name', isTitle: true, required: true },
          { type: 'image', name: 'photo', label: 'Photo', uploadDir: () => 'forum-people' },
          { type: 'string', name: 'role', label: 'Current role' },
          { type: 'string', name: 'organisation', label: 'Organisation' },
          { type: 'string', name: 'location', label: 'Location' },
          { type: 'string', name: 'programme', label: 'Programme (optional)' },
          { type: 'string', name: 'graduationYear', label: 'Graduation year (optional)' },
          {
            type: 'string',
            name: 'intro',
          ...
          { type: 'string', name: 'expertiseTags', label: 'Expertise / interest tags', list: true },
          { type: 'string', name: 'canHelpWith', label: '"Can help with…" topics', list: true },
          { type: 'string', name: 'interestedIn', label: '"Interested in…" topics (optional)', list: true },
          { type: 'string', name: 'linkedinUrl', label: 'LinkedIn or other approved public link' },
          { type: 'boolean', name: 'featured', label: 'Featured on the Forum home' },
          { type: 'boolean', name: 'draft', label: 'Draft (hidden from the live site)' },
        ],
      },
      {
        name: 'forumOpportunity',
        label: 'Forum — Opportunities',
        path: 'content/forum-opportunities',
        format: 'json',
        ui: { router: () => undefined },
        fields: [
          {
          ...
          { type: 'string', name: 'location', label: 'Location / remote status' },
          {
            type: 'string',
            name: 'description',
          ...
          { type: 'string', name: 'deadline', label: 'Deadline (optional)' },
          { type: 'string', name: 'relevantFor', label: 'Who this is relevant for (optional)' },
          { type: 'string', name: 'applyUrl', label: 'External application link', required: true },
          { type: 'boolean', name: 'featured', label: 'Featured on the Forum home' },
          { type: 'boolean', name: 'draft', label: 'Draft (hidden from the live site)' },
        ],
      },
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'date', label: 'Date (YYYY-MM-DD)', required: true },
          { type: 'string', name: 'time', label: 'Time (optional, e.g. "6:00 PM HKT")' },
          { type: 'string', name: 'location', label: 'Location, or a virtual link' },
          {
            type: 'string',
            name: 'description',
            label: 'Description',
      ...
      {
        name: 'forumAnswer',
        label: 'Forum — Ask the Professor',
        path: 'content/forum-answers',
        format: 'json',
        ui: { router: () => undefined },
        fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            type: 'string',
            name: 'introLede',
            label: 'Forum home — lede',
            ui: { component: 'textarea' },
          },
          {
            type: 'string',
            name: 'guidelinesBody',
            label: 'Community guidelines (leave a blank line between paragraphs)',
            ui: { component: 'textarea' },
          },
        ],
      },
