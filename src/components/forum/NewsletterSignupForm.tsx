  ...
  return (
    <form className={styles.form} onSubmit={onSubmit}>
      ...
      <p className={styles.blurb}>
        Occasional notes from the professor, community highlights, and new
        opportunities — sent by email, unsubscribe any time.
      </p>
      ...
      <p className={styles.note} role="status" aria-live="polite">
        {state === 'ok' && "Thank you — you're subscribed."}
